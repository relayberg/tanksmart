...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md hover:shadow-lg hover:shadow-primary/25 hover:scale-[1.02] active:scale-[0.98]",
        destructive:
        ...
        hero:
          "bg-warm text-primary-foreground shadow-lg shadow-glow-sm hover:shadow-glow hover:scale-[1.03] active:scale-[0.98]",
        "hero-outline":
        ...
        warm:
          "bg-accent text-accent-foreground border border-primary/20 hover:bg-primary/10 hover:border-primary/40",
        success:
